...
The dataset used is `lung_cancer.csv`, which contains patient information and reported symptoms.
...
4. **Feature Correlations**
   * **Highest correlations:** Smoking, Yellow Fingers, and Anxiety.
...
* **Description:** A supervised learning model that finds the optimal hyperplane for classification to accurately separate the classes.
...
* **Description:** An ensemble learning method that constructs multiple decision trees and merges their predictions for a highly accurate and stable output.
...
*Based on the Random Forest model (Top features shown):*
